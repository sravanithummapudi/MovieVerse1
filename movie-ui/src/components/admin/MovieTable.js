...
movieImdb, movieTitle, moviePoster	Controlled input values for the movie form
movieTextSearch	Controlled input for search
handleInputChange	Updates input state (used for both form & search)
handleAddMovie	Adds a new movie
handleDeleteMovie	Deletes a movie by IMDb ID
handleSearchMovie	Triggers movie search on submit*/
...
function MovieTable({ movies, movieImdb, movieTitle, moviePoster, movieTextSearch, handleInputChange, handleAddMovie, handleDeleteMovie, handleSearchMovie }) {
  ...
  return (
    //Submits the form when user presses Enter
    <Fragment>
